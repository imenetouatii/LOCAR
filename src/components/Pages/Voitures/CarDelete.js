...
const useCars = () => {
 ...
 function Delete(id) {
    firebase    
      ...
      .collection("voitures")    //Accès à la collection "positions"
      .doc(id)                     //Accès au document dont l'identifiant est "id"
      .delete()                    //Supprimer le document
      .then(() => {
          console.log("Suppression effectuée");
      }).catch((error) => {                 //Affiche un message d'erreur si une erreur survient de Firebase
          console.log("Une erreur venant de Firebase est survenue : ",error);
      })           
            ...
            <div>
              ...
              <div className="row">
                <img
                  ...
                  width="auto"
                />
                <button className='supp' onClick={() => Delete(car.id)}><TiDelete/></button>
              </div>
